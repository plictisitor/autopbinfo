// ==UserScript==
// @name         pbinfo.ro Clipboard Executor
// @namespace    http://pbinfo.ro/
// @version      0.1
// @description  execute code from clipboard
// @author       traian
// @match        https://www.pbinfo.ro/?pagina=probleme&id=*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=pbinfo.ro
// @grant        none
// ==/UserScript==
...
function checkPoints() {
    if (document.getElementsByClassName("padding10 text-center lead roundbox").length > 0) {
...
$(document).ready(function() {
    navigator.clipboard.readText()
        .then(text => {
            ...
            setTimeout(`$("#btn-submit")[0].click()`, 500) // 500 ms timeout
        })
        .catch(err => {
